  ...
  <tr>
    <td style="text-align:center">
      <div class="speaker-avatar">
        <img src="assets/img/speakers/emilie_morvant.jpg" alt="Emilie Morvant">
      </div>
    </td>
    <td style="text-align:center">
      <div class="speaker-avatar">
        <img src="assets/img/speakers/ammar_mian.jpeg" alt="Ammar Mian">
      </div>
    </td>
    <td style="text-align:center">
      <div class="speaker-avatar">
        <img src="assets/img/speakers/stephane_chretien.jpg" alt="Stéphane Chrétien">
      </div>
    </td>
    <td style="text-align:center">
      <div class="speaker-avatar">
        <img src="assets/img/speakers/user.jpg" alt="Prenom Nom">
      </div>
    </td>
  </tr>
  <tr>

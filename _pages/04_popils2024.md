...
<table style="width:100%">
  <tr>
    <td style="text-align:center"><img class="rounded-image" src="../../assets/img/speakers/elisa_ricietti.jpg"></td>
    <td style="text-align:center"><img class="rounded-image" src="../../assets/img/speakers/loic_denis.png"></td>
    <td style="text-align:center"><img class="rounded-image" src="../../assets/img/speakers/nicolas_ducros.png"></td>
    <td style="text-align:center"><img class="rounded-image" src="../../assets/img/speakers/yohann_de_castro.png"></td>
  </tr>
  <tr>
